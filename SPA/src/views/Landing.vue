<template>
  <v-content>
    <section>
      <v-parallax :src="require('@/assets/paragliding.jpg')" height="1000">
        <v-layout column align-center justify-center class="white--text">
          <h1 class="white--text mb-2 display-1 text-center text-uppercase">
            <span>
              <i>Track</i>
            </span>
      ...
      <v-layout column wrap class="my-12" align-center>
        <v-flex xs12 sm4 class="my-4">
          <div class="text-center">
            <h2
              class="headline"
            >Track anyone anywhere in the world using the most popular and trusted satellite trackers</h2>
            <span class="subheading">Garmin inReach, Delorme inReach, SPOT etc...</span>
          </div>
        </v-flex>
        <v-flex xs12>
    ...
    <section>
      <v-parallax :src="require('@/assets/trackers.jpg')" height="500">
        <v-layout column align-center justify-center>
          ...
          <em>Sign up today</em>
          <v-btn class="mt-12" color="blue lighten-2" dark large to="login">Sign Up / Login</v-btn>
        </v-layout>
      </v-parallax>
    </section>
            ...
            <v-card flat class="transparent">
              ...
              <v-list class="transparent">
                <v-list-item>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>760-846-0475</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-action>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>California, US</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-action>
                  ...
                  <v-list-item-content>
                    <v-list-item-title>markfaulk350@gmail.com</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </v-list>
            </v-card>
    ...
    <v-footer color="blue darken-2">
      <v-layout row wrap align-center>
        <v-flex xs12>
          <div class="white--text ml-4">&copy; 2020</div>
        </v-flex>
      </v-layout>
    </v-footer>
  </v-content>
