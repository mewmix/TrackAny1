      ...
      <v-col cols="12" md="7">
        <v-card class="pb-5">
          ...
          <v-card-text class="text-center">
            ...
            <v-btn color="grey darken-3" rounded class="mr-0">+ Follow</v-btn>
          </v-card-text>
          <v-row justify="center">
            <v-col cols="12" md="11">
              <v-expansion-panels>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-list three line>
                      <v-list-item v-for="device in trackers" :key="device.link">
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-list two line>
                      <v-list-item class="pl-0" v-for="group in groups" :key="group.name">
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <v-list two line>
                      <v-list-item class="pl-0" v-for="person in following" :key="person.id">
                        <v-list-item-avatar>
                          <img
                            :src="person.photo"
                          />
...
export default {
  ...
  data() {
    return {
      trackers: [
        { name: "Mark's Primary Tracker", type: "Garmin inReach Explorer +", active: "2 weeks ago", link: "share.garmin.com/markfaulk" },
        { name: "Mark's Backup Tracker", type: "SPOT Gen3", active: "4 years ago", link: "share.garmin.com/markfaulk350" }
      ],
      groups: [
        { name: 'San Diego Hang Gliding & Paragliding', status: 'Member' },
        { name: 'Red Bull X-Alps 2020', status: 'Follower' },
        { name: 'California PPG', status: 'Creator' },
      ],
      following: [
        { id: 2, name: "Chris Cote", location: "Encinitas, CA", photo: "https://randomuser.me/api/portraits/men/80.jpg"},
        { id: 3, name: "Phil Cussman", location: "La Jolla, CA", photo: "https://randomuser.me/api/portraits/men/81.jpg"},
        { id: 4, name: "Wild Bill", location: "4S Ranch, CA", photo: "https://randomuser.me/api/portraits/men/82.jpg"},
        { id: 5, name: "Ryan Roberts", location: "Encinitas, CA", photo: "https://randomuser.me/api/portraits/men/83.jpg"},
        { id: 6, name: "Gavin McClurg", location: "Salt Lake City, UT", photo: "https://randomuser.me/api/portraits/men/84.jpg"},
        { id: 7, name: "Christian Maurer", location: "Bern, SW", photo: "https://randomuser.me/api/portraits/men/85.jpg"},
      ]
